...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Cowley.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("QW", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S CowleyIQ-X kill
screen -S CowleyIQ./CowleyIQ
done
]])  
file:close() 
...
__ℳ_________🦅________Cowley_𝕋𝕖𝔸𝕞_🦅_________ᔕ ____
...
os.execute('wget https://raw.githubusercontent.com/COWLEYBOT1/COWLEYBOT/master/BOYKA.lua')
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/COWLEYBOT1/Files_BOYKA/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/COWLEYBOT1/Files_BOYKA/master/File_Bot/"..file)
if res == 200 then
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel COWLEY 🦅](https://t.me/iraqqpqp)\n'
send(msg.chat_id_, msg.id_,text)     
end    
